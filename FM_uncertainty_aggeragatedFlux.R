...
daily.nh4<-aggregateSolute(lc.nh4.data,meta,'flux total','day')
...
write.csv(monthly.nh4,'FM.monthlyNH4Load_comp.csv')
write.csv(monthly.no3,'FM.monthlyNO3Load_comp.csv')
write.csv(monthly.li.no3,'FM.monthlyNO3Load_interp.csv')
write.csv(monthly.srp,'FM.monthlySRPLoad_comp.csv')
write.csv(monthly.li.ss,'FM.monthlySSLoad_interp.csv')
write.csv(monthly.nh4.conc,'FM.monthlyNH4conc_comp.csv')
write.csv(monthly.li.no3.conc,'FM.monthlyNO3conc_interp.csv')
write.csv(monthly.srp.conc,'FM.monthlySRPconc_comp.csv')
write.csv(monthly.li.ss.conc,'FM.monthlySSconc_interp.csv')
write.csv(monthly.ss,'FM.monthlySSLoad_comp.csv')


setwd('~/Documents/Miami U/acton data/annual load estimates')
write.csv(yearly.nh4,'FM.annualNH4Load_comp.csv')
write.csv(yearly.no3,'FM.annualNO3Load_comp.csv')
write.csv(yearly.li.no3,'FM.annualNO3Load_interp.csv')
write.csv(yearly.srp,'FM.annualSRPLoad_comp.csv')
write.csv(yearly.li.ss,'FM.annualSSLoad_interp.csv')

write.csv(wyearly.nh4,'FM.annualNH4Load_comp.csv')
write.csv(wyearly.no3,'FM.annualNO3Load_comp.csv')
write.csv(wyearly.li.no3,'FM.annualNO3Load_interp.csv')
write.csv(wyearly.srp,'FM.annualSRPLoad_comp.csv')
write.csv(wyearly.li.ss,'FM.annualSSLoad_interp.csv')

setwd('~/Documents/Miami U/loadflex/aggregated data')
save.image('FM_aggregatedFlux.RData')