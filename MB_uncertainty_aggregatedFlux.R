...
#load('threeYearCalibration_MB_reducedSampling.summaryStats.RData')
...
write.csv(monthly.nh4,'MB.monthlyNH4Load_comp.csv')
write.csv(monthly.no3,'MB.monthlyNO3Load_comp.csv')
write.csv(monthly.li.no3,'MB.monthlyNO3Load_interp.csv')
write.csv(monthly.srp,'MB.monthlySRPLoad_comp.csv')
write.csv(monthly.li.ss,'MB.monthlySSLoad_interp.csv')
write.csv(monthly.nh4.conc,'MB.monthlyNH4conc_comp.csv')
write.csv(monthly.li.no3.conc,'MB.monthlyNO3conc_interp.csv')
write.csv(monthly.srp.conc,'MB.monthlySRPconc_comp.csv')
write.csv(monthly.li.ss.conc,'MB.monthlySSconc_interp.csv')
write.csv(monthly.ss,'MB.monthlySSLoad_comp.csv')

setwd('~/Documents/Miami U/acton data/annual load estimates')
write.csv(yearly.nh4,'MB.annualNH4Load_comp.csv')
write.csv(yearly.no3,'MB.annualNO3Load_comp.csv')
write.csv(yearly.li.no3,'MB.annualNO3Load_interp.csv')
write.csv(yearly.srp,'MB.annualSRPLoad_comp.csv')
write.csv(yearly.li.ss,'MB.annualSSLoad_interp.csv')

setwd('~/Documents/Miami U/loadflex/aggregated data')
save.image('MB_aggregatedFlux.RData')